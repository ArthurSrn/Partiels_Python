...
class ReportController:
    ...
    def tournament_players_alphabetical(self):
        """
        Charge la liste des joueurs pour un tournoi spécifique, triée de A-Z par de prénom.
    ...
    def get_tournament_players_sorted(self, tournament_id):
        """
        Charge et retourne la liste des joueurs pour un tournoi spécifié, triée par décroissant.
